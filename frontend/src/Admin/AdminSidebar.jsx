...
const menu = [
  ...
  { title: "Appointment", icon: <ShoppingBagIcon />, path: "/appointments" },
  { title: "Service", icon: <ShopTwoIcon />, path: "/menu" },
  { title: "Service Category", icon: <CategoryIcon />, path: "/category" },
